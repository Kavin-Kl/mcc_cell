...
// Insert into drives (added company_url & graduating_year)
$stmt = $conn->prepare("INSERT INTO drives (
    company_name, drive_no, open_date, close_date, jd_file, form_link, extra_details, created_by, form_fields, company_url, graduating_year, work_location
) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
