...
function build_filters(&$types, &$params) {
    ...
    $fields = [
        ...
        "company_name", "allow_reapply","offer_type", "comment", "editable_comment", "Offcampus_selection"
    ];

    $exactMatchFields = [
        "upid", "batch", "placed_status", "program_type",
        "reg_no", "year_of_passing", "allow_reapply","offer_type", "Offcampus_selection"
    ];
    ...
    if (!empty($_POST['search_query'])) {
        ...
        $searchableColumns = [
          ...
          "s.placed_status", "s.offer_type", "s.company_name", "s.allow_reapply",
